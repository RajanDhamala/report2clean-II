...
const ReportPage = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    // Dummy auth check: simulate no user logged in to force navigation to register
    const isUserLoggedIn = true; // Change to false to simulate no user
    ...
    try {
      ...
      // Simulate report submission success
      setSuccess(true);
      setTimeout(() => {
